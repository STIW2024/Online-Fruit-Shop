...
<html>
    <head>
        <link rel="stylesheet" href="updateProfileCSS.css">
    ...
    <body>
        ...
        <a href="mainPage.jsp" value="back">Back</a>
        <form style="border:1px solid #ccc" action="updateProcess.jsp">
            <div class="container">
                <p><b>Password:</b> 
                ...
                <p><b>E-mail:</b> 
                    <input type="text" id="email" name="email" placeholder="Enter Email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
                           title="Please enter Email with standard format"/>
                </p>
                </p>
                <p><b>Customer Phone Number:</b> 
                    <input type="text" id="custPhone" name="custPhone" placeholder="Enter Phone Number" required
