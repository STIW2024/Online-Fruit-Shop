...
<html>
    ...
    <body onload="welcome()">
        ...
        <div class="gallery">
            <img src="https://doremi.my/wp-content/uploads/2015/05/gong-pear-300x300.jpg" name="gongpear" weight="400" height="400" class="image" border="0"></a>
            <div class="desc">
                Gong Pear
                <p>6 pcs Rm 9.99</p>
                <p>Quantity :<input type="number" name="quantity"</p>
                <p><button type="submit" name="buying" onclick="buying()">Buy</button>
            </div>
        </div>
        <div class="gallery">
        ...
        <script>
            function buying() {
                alert("Add to Cart Successful Please Make Your Payment at Cart Site");
            }
